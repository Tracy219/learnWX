...
TracysFrame = wx.Frame(None, wx.ID_ANY, "Hello Josh!!!", size = (400, 100), pos=(1000, 300)) 
# None means it is top level. It has no parent frame.

# Show the frame.
TracysFrame.Show(True)
...
#What does it do?
# It change the initial length and width of the frame it creates.

#3. Add the argument pos=(1000,300) to the frome constructor on line 16.
#What does it do?
# It change the position of the new frame from the higher right side.